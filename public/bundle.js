...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsUserList = __webpack_require__(202);
	...
	exports['default'] = _react2['default'].createElement(
		...
		_react2['default'].createElement(
			Route,
			{ name: 'userlist', path: 'groups/:groupId', handler: _componentsMain2['default'] },
			_react2['default'].createElement(Route, { name: 'userprofile', path: 'user/:userId', handler: _componentsMain2['default'] })
		)
	);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _underscore = __webpack_require__(198);
	...
	var _UserInGroup = __webpack_require__(200);

	var _UserInGroup2 = _interopRequireDefault(_UserInGroup);

	var _Profile = __webpack_require__(201);

	var _Profile2 = _interopRequireDefault(_Profile);

	var groups = [{ "title": "БТК-01", "users_count": 2, "id": 1 }, { "title": "ТБ-91", "users_count": 1, "id": 2 }];
		...
		render: function render() {
			var groupNodes = groups.map(function (group) {
				return _react2['default'].createElement(
					'li',
					null,
					_react2['default'].createElement(_Group2['default'], { name: group.title, count: group.users_count, key: group.id, groupId: group.id })
				);
			});
			if (!!this.getParams().groupId) {
				var groupId = parseInt(this.getParams().groupId, 10);
				var groupObj = _underscore2['default'].findWhere(groups, { id: groupId });
				var usersInGroup = _underscore2['default'].where(users, { group_id: groupId });
				var userNodes = usersInGroup.map(function (user) {
					return _react2['default'].createElement(
						'li',
						null,
						_react2['default'].createElement(_UserInGroup2['default'], { user: user, key: user.id })
					);
				});
				var groupOut;
				if (!!groupObj) {
					...
					groupOut = _react2['default'].createElement(
						'div',
						null,
						_react2['default'].createElement(
							'h3',
			...
			if (!!this.getParams().userId) {
				var userId = parseInt(this.getParams().userId, 10);
				var userObj = _underscore2['default'].findWhere(users, { id: userId });
				var userOut = _react2['default'].createElement(_Profile2['default'], { user: userObj });
			}
			return _react2['default'].createElement(
				'div',
				{ className: 'container' },
				...
				_react2['default'].createElement(
					...
					_react2['default'].createElement(
						'div',
						{ className: 'col-md-4' },
						groupOut ? groupOut : _react2['default'].createElement('div', null)
					),
					_react2['default'].createElement(
						'div',
						{ className: 'col-md-4' },
						userOut ? userOut : _react2['default'].createElement('div', null)
					)
				)
			);
		}
	...
	exports['default'] = _react2['default'].createClass({
	  ...
	  render: function render() {
	    ...
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(
	        _reactRouter.Link,
	        { to: '/groups/' + user.group_id + '/user/' + user.id },
	        user.name,
	        ' ',
	        _react2['default'].createElement(
	          'b',
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = _react2['default'].createClass({
		...
		mixins: [_reactRouter2['default'].State],
		render: function render() {
			var groupId = parseInt(this.getParams().groupId, 10);{/*this gets param :groupId from current url*/}
			var userId = this.getParams().userId ? parseInt(this.getParams().userId, 10) : null;
			var usersInGroup = _underscore2['default'].where(users, { group_id: groupId });
			var userNodes = usersInGroup.map(function (user) {
				return _react2['default'].createElement(
					'li',
			...
			var userObj = userId ? _underscore2['default'].findWhere(users, { id: userId }) : null;
			...
			return _react2['default'].createElement(
				...
				_react2['default'].createElement(
					...
					_react2['default'].createElement(
						'h3',
						null,
						'User List in Group with Id:',
						groupId
					),
					userNodes
				),
				userId ? _react2['default'].createElement(_Profile2['default'], { user: userObj }) : _react2['default'].createElement('div', null)
			);
		}
	});
	module.exports = exports['default'];
